#include "serial_pmon.h"
#include "esphome/core/log.h"

namespace esphome {
namespace serial {

static const char *TAG = "serial.pmon";

void SerialPMon::loop() {
...
// todo: Replace this with MonkMakes specific code
void SerialPMon::parse_values_() {
...
void SerialCSV::dump_config() {
  ESP_LOGCONFIG("", "Serial Plant Monitor");
  for (auto sens : this->sensors_) {
